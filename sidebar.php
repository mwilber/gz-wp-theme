...
<aside id="secondary" class="widget-area">
	...
	<?php elseif($post_type == "portfolio"): ?>
		<h3 style="color:red;">Portfolio Sidebar</h3>
	<?php elseif($post_slug == "about"): ?>
		<a href="mailto:<?php the_field('email_address', 'option'); ?>" class="button">
		...
		<?php if( have_rows('profile_pages', 'option') ): ?>
			<?php while ( have_rows('profile_pages', 'option') ) : the_row(); ?>
				<a href="<?php the_sub_field('url'); ?>" class="button" style="background-color:<?php the_sub_field('color'); ?>">
